...
exports.lists =
	...
	"special order III": ["D,C,B", "D,C,B,A,E,F"]
	"empty list": ["", "A,B,C,D,E,F"]
	"try to sort undefined elements": ["X,D,C,Y,B,Z", "D,C,B,A,E,F"]
	"sort a id multiple times": ["D,C,D,B,D", "D,C,B,A,E,F"]
	...
	"sort by non unique key": ["666,42,23,13", "666,42,23,13,13,42", {key:"age"}]
